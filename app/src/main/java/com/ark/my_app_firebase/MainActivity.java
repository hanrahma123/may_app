...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // button_send = (Button) findViewById(R.id.button_send_firebase);
        ...
        input_email = (EditText)findViewById(R.id.log_Email);
        input_pass = (EditText)findViewById(R.id.log_Password);
            ...
            mAuth.signInWithEmailAndPassword(mail,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if (task.isSuccessful()) {
                        finish();
                        Intent intent = new Intent(MainActivity.this, TutorView.class);
    ...
    protected void onStart() {
        ...
        if(mAuth.getCurrentUser() != null){//means user is already signed in
            ...
            finish();
            startActivity(new Intent(this,TutorView.class));
        }
    }
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.btnRegister: // Toast.makeText(MainActivity.this, "button pressed", Toast.LENGTH_LONG).show();
                                            startActivity(new Intent(this, SignupActivity.class));
                                            break;
            case R.id.btnLogin: // Toast.makeText(MainActivity.this, "button pressed", Toast.LENGTH_LONG).show();
                                            userLogin();
                                            break;
